...
這個專案是我從零基礎學習程式開發4個月後的成果展現。

從最初的 HTML/CSS/JS 3件套基礎，到學習 Vue 3 系列，再到後端 Express 開發，每一步都充滿挑戰。

常常有新的專業知識與插件要學習，都要自學解決問題才能持續開發。

因此最大的收穫就是，慢慢理解了全端開發的完整流程，以及如何運用 AI 輔助開發來提升效率。
